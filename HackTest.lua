...
function Dino:CreateWindow(dinotitle)
    ...
    Window.BackgroundColor3 = Color3.fromRGB(15, 31, 21)
    ...
    DinoHubText1.BackgroundColor3 = Color3.fromRGB(19, 10, 43)
    ...
    DinoHubText1.TextColor3 = Color3.fromRGB(78, 110, 99)
    DinoHubText1.TextSize = 13.000
    
    DinoHubText2.Name = "DinoHubText2"
    DinoHubText2.Parent = Window
    DinoHubText2.BackgroundColor3 = Color3.fromRGB(19, 10, 43)
    ...
    DinoHubText2.Text = ""
    DinoHubText2.TextColor3 = Color3.fromRGB(78, 110, 99)
    DinoHubText2.TextSize = 13.000
    
    WindowText.Name = "WindowText"
    WindowText.Parent = Window
    WindowText.BackgroundColor3 = Color3.fromRGB(19, 10, 43)
    ...
    WindowText.TextColor3 = Color3.fromRGB(78, 110, 99)
    ...
    TabWindow.BackgroundColor3 = Color3.fromRGB(44, 9, 69)
...
stat:CreateToggle("Demon Fruit", function(value)
    _G.DF = value
